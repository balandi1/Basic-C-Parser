...
#line 103 "calc.tab.c" /* yacc.c:339  */
...
#line 142 "calc.tab.c" /* yacc.c:355  */
...
union YYSTYPE
{
#line 51 "calc.y" /* yacc.c:355  */

	char idName[100];
	char mainFunc[100];	 
	struct number numberConst;

#line 182 "calc.tab.c" /* yacc.c:355  */
};
...
#line 199 "calc.tab.c" /* yacc.c:358  */
...
{
       0,    72,    72,    76,    79,    80,    83,    97,   113,   114,
     117,   121,   125,   131,   155,   178,   182,   189,   193
};
#endif
...
{
  "$end", "error", "$undefined", "TOK_SEMICOLON", "TOK_SUB", "TOK_MUL",
  "TOK_NUM", "TOK_PRINTID", "TOK_PRINTEXP", "TOK_INT", "TOK_FLOAT",
  "TOK_IDENTIFIER", "TOK_EQUAL", "TOK_ACCESS_SPECIFIER",
  "TOK_TYPE_QUALIFIER", "TOK_FUNC_STRING", "TOK_OPEN_BRAC",
  "TOK_CLOSE_BRAC", "TOK_CUR_OPEN", "TOK_CUR_CLOSE", "TOK_FLOAT_CONST",
  "TOK_INT_CONST", "$accept", "FunctionDefinition", "FunctionName",
  "VariableDefs", "VariableDef", "Statements", "Statement", "Exp",
  "NumberConstant", YY_NULLPTR
};
#endif
...
{
     -11,    -4,     5,     6,     8,   -16,    13,   -16,    15,    17,
      -5,    13,    24,    26,   -10,   -10,    18,    12,    -5,   -16,
     -16,   -16,   -16,   -16,   -16,     4,   -16,    11,   -10,   -16,
     -16,   -16,   -10,   -10,   -16,    16,    27,   -16,   -16
};
...
static const yytype_uint8 yydefact[] =
{
       0,     0,     0,     0,     0,     1,     4,     3,     0,     0,
       8,     4,     0,     0,     0,     0,     0,     0,     8,     5,
       6,     7,    16,    18,    17,     0,    15,     0,     0,     2,
       9,    11,     0,     0,    12,     0,    14,    13,    10
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -16,   -16,   -16,    22,   -16,    19,   -16,   -15,   -16
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,    10,    11,    17,    18,    25,    26
};
...
{
      27,    22,    14,    15,     1,     5,    16,    31,    32,    33,
      23,    24,     4,    35,    34,    32,    33,    36,    37,    38,
      32,    33,     8,     9,     6,     7,    12,    20,    13,    21,
      28,    29,    33,    19,     0,     0,     0,    30
};

static const yytype_int8 yycheck[] =
{
      15,    11,     7,     8,    15,     0,    11,     3,     4,     5,
      20,    21,    16,    28,     3,     4,     5,    32,    33,     3,
       4,     5,     9,    10,    18,    17,    11,     3,    11,     3,
      12,    19,     5,    11,    -1,    -1,    -1,    18
};
...
{
       0,    15,    23,    24,    16,     0,    18,    17,     9,    10,
      25,    26,    11,    11,     7,     8,    11,    27,    28,    25,
       3,     3,    11,    20,    21,    29,    30,    29,    12,    19,
      27,     3,     4,     5,     3,    29,    29,    29,     3
};
...
#line 84 "calc.y" /* yacc.c:1646  */
    {
						int idIndex=SearchElement((yyvsp[-1].idName));
						if(idIndex<=-1)
						{
							Insert((yyvsp[-1].idName),"int","0");
						}
						else
						{
...
#line 98 "calc.y" /* yacc.c:1646  */
    {
						...
						if(idIndex<=-1)
						{
							...
							Insert((yyvsp[-1].idName),"float","0.0");
						}
						else
						{
							yyerror("Identifier already present");
...
#line 118 "calc.y" /* yacc.c:1646  */
    {
						AssignValue((yyvsp[-3].idName),(yyvsp[-1].numberConst).numberType,(yyvsp[-1].numberConst).intValue,(yyvsp[-1].numberConst).floatValue);
					}
...
#line 122 "calc.y" /* yacc.c:1646  */
    {
						PrintValue((yyvsp[-1].numberConst).numberType,(yyvsp[-1].numberConst).intValue,(yyvsp[-1].numberConst).floatValue);
					}
...
#line 132 "calc.y" /* yacc.c:1646  */
    {
						if(strcmp((yyvsp[-2].numberConst).numberType,(yyvsp[0].numberConst).numberType)==0)
						{
							struct number calcValue;
							if(strcmp((yyvsp[-2].numberConst).numberType,"int")==0)
							{
								calcValue.numberType="int";
								calcValue.intValue=(yyvsp[-2].numberConst).intValue * (yyvsp[0].numberConst).intValue;
							}
							else
							{
								calcValue.numberType="float";
								calcValue.floatValue=(yyvsp[-2].numberConst).floatValue * (yyvsp[0].numberConst).floatValue;
							}
							(yyval.numberConst)=calcValue;
						}
						else
						{
							yyerror("Type error");
...
#line 179 "calc.y" /* yacc.c:1646  */
    {
							(yyval.numberConst)=(yyvsp[0].numberConst);
				    }
...
#line 183 "calc.y" /* yacc.c:1646  */
    {
						...
						(yyval.numberConst)=GetIdValue((yyvsp[0].idName));
					}
...
#line 1426 "calc.tab.c" /* yacc.c:1646  */
    break;
...
#line 1434 "calc.tab.c" /* yacc.c:1646  */
    break;
